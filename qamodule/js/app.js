    ...
    constructor() {
        this.questions = [
            ...
            },
            {
                ...
                answer: `QC (Quality Control) – это процесс нахождения ошибок в 
                        продукте, с целью их последующего исправления . Задачей 
                        Quality Control является поддержка качества продукта в 
                        текущий момент времени. Quality Control ориентирован на 
                        продукт , разрабатываемый в данный момент. 
                        (ориентирован на продукт и его качество)(включает в себя: 
                        выявление и устранение дефектов, нагрузочное тестирование, 
                        соответствие требованиям, соответствие проекта указанному 
                        качеству.)
                    <br>QA(Quality Assurance) – это процесс нахождения ошибок в 
                        продукте, с целью их последующего исправления . 
                        Задачей Quality Control является поддержка качества 
                        продукта в текущий момент времени. Quality Control 
                        ориентирован на продукт , разрабатываемый в данный момент. 
                        (ориентирован на продукт и его качество)(включает в себя: 
                        выявление и устранение дефектов, нагрузочное тестирование, 
                        соответствие требованиям, соответствие проекта указанному 
                        качеству.)
            ...
            {
                question: 'Что такое Регресионное тестрование ',
                answer: `это набор тестов, направленных на обнаружение 
                        дефектов в уже протестированных участках приложения. 
                        Делается это совсем не для того, чтобы окончательно убедиться 
                        в отсутствии багов, а для поиска и исправления регрессионных 
                        ошибок`
            },
            {
                question: 'none',
